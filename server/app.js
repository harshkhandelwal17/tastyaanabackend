...
const sellerMealRoutes = require('./routes/sellerMealRoutes');
...
const sellerVehicleRoutes = require('./routes/sellerVehicleRoutes');
...
app.use("/api/user", require('./routes/userProfile')); // Minimal user profile routes
...
app.use('/api/seller/meal-edit', sellerMealRoutes); // Seller meal edit routes
...
// Test routes for vehicle rental sellers
