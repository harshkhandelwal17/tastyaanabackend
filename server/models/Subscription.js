...
subscriptionSchema.methods.updateDeliveryStatus = async function(date, shift, status, options = {}) {
  ...
  // This ensures transparent and single-source meal count management
...
subscriptionSchema.methods.skipMeal = async function(date, shift, reason, userId) {
  ...
  // REMOVED: Meal count deduction logic - now handled ONLY in updateDynamicDeliveryStatus function
  // Skip tracking is maintained for scheduling/display purposes only
  console.log('Meal skipped via skipMeal method - counts managed by updateDynamicDeliveryStatus only');
  ...
  // REMOVED: Expiry check - now handled centrally based on delivered meals only
