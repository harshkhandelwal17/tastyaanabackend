...
router.post('/',
  ...
  [
    ...
    body('maxUsagePerUserPerDay')
      .optional()
      .isInt({ min: 1 })
      .withMessage('Max usage per user per day must be a positive integer'),
...
/**
 * @route   GET /api/coupons/:id/enhanced-stats
 * @desc    Get enhanced coupon usage statistics (User)
 * @access  Private
 */
router.get('/:id/enhanced-stats',
  authenticate,
  [
    param('id')
      .isMongoId()
  ...
  handleValidationErrors,
  couponController.getEnhancedUsageStatistics
);
