...
import { ArrowLeft,MessageCircle, Phone, Mail, Clock, Search, ChevronDown, ChevronRight, HelpCircle, Star, ArrowRight } from 'lucide-react';
...
const CustomerSupport = () => {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      to:"mailto:contact@tastyaana.com"
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-yellow-50">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-16 text-center">
             <button
            onClick={() => navigate(-1)}
            className=" absolute top-4 left-4 inline-flex items-center space-x-2 text-gray-700 hover:text-orange-600
                       rounded-sm px-3 py-2 text-sm font-medium
                       transition-colors focus:outline-none focus:ring-2 focus:ring-orange-400 border-1"
          >
      ...
      <div className="max-w-6xl mx-auto px-4 pb-16">
          ...
          {contactMethods.map((method, index) => (
            <div key={index} className="group cursor-pointer flex-1">
              <div className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
                ...
                <NavLink to={method.to} className="inline-flex items-center space-x-2 text-orange-600 font-semibold hover:text-orange-700 transition-colors">
        ...
        <div className="mt-16 grid md:grid-cols-2 gap-8">
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
            ...
            <NavLink to="/orders"className="inline-flex items-center space-x-2 bg-orange-100 text-orange-700 px-6 py-3 rounded-xl font-semibold hover:bg-orange-200 transition-colors">
