...
const SellerBookingManagement = () => {
  ...
  const [approveBooking, { isLoading: isApproving }] =
    useApproveBookingMutation();
  const [respondToExtension, { isLoading: isRespondingToExtension }] =
    useRespondToExtensionMutation();
  ...
  const handleBookingApproval = async () => {
    try {
      ...
      toast.error(
        error.data?.message || `Failed to ${approvalData.action} booking`
      );
    }
  };
  ...
  const handleExtensionResponse = async (action, rejectionReason = "") => {
    try {
      ...
      toast.error(
        error.data?.message || "Failed to respond to extension request"
      );
    }
  };
          ...
          <div className="border-b border-gray-200">
            ...
            >
              <button
                ...
                } whitespace-nowrap py-2 px-1 sm:px-3 border-b-2 font-medium text-xs sm:text-sm flex-shrink-0`}
              >
                <span className="hidden sm:inline">All Bookings</span>
                <span className="sm:hidden">All</span>
                <span className="bg-gray-100 text-gray-900 ml-1 sm:ml-2 py-0.5 px-1.5 sm:px-2.5 rounded-full text-xs font-medium">
                  {bookings.length}
                </span>
              </button>
              ...
              <button
                ...
                className={`${
                  activeTab === "pending_approval"
                    ...
                    : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"
                } whitespace-nowrap py-2 px-1 sm:px-3 border-b-2 font-medium text-xs sm:text-sm relative flex-shrink-0`}
              >
                <AlertCircle className="w-3 h-3 sm:w-4 sm:h-4 inline mr-1" />
                <span className="hidden sm:inline">Pending Approval</span>
                <span className="sm:hidden">Approval</span>
                <span className="bg-yellow-100 text-yellow-800 ml-1 sm:ml-2 py-0.5 px-1.5 sm:px-2.5 rounded-full text-xs font-medium">
              ...
              >
                ...
                <span className="bg-purple-100 text-purple-800 ml-1 sm:ml-2 py-0.5 px-1.5 sm:px-2.5 rounded-full text-xs font-medium">
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 border border-gray-300 rounded-md hover:bg-gray-200 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
              >
                Clear Filters
              </button>
            </div>
                          ...
                          >
                            <td className="px-3 sm:px-6 py-4 whitespace-nowrap">
                              <div>
                                ...
                                {/* Mobile: Show vehicle info here too */}
                            ...
                            <td className="hidden sm:table-cell px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center">
                                {formattedBooking.vehicle.image && (
                                  <img
                                    className="h-8 w-8 lg:h-10 lg:w-10 rounded-lg object-cover mr-3"
                            ...
                            <td className="px-3 sm:px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center justify-between space-x-2">
                                ...
                                {/* Headcount Bubble - Responsive */}
                                <div className="flex-shrink-0">
                                  <div className="bg-blue-100 text-blue-800 text-xs font-semibold inline-flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 rounded-full border border-blue-200">
                                    <User className="w-2.5 h-2.5 sm:w-3 sm:h-3 mr-0.5 sm:mr-1" />
                                    <span className="text-xs sm:text-xs">
                                      {formattedBooking.headCount ||
                                        formattedBooking.passengers ||
                                        formattedBooking.guestCount ||
                                        1}
                                    </span>
                                  </div>
                                </div>
                            ...
                            <td className="px-3 sm:px-6 py-4 whitespace-nowrap">
                              <span
                                className={`inline-flex items-center px-2 sm:px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusBadgeColor(
                              ...
                              >
                                ...
                                <span className="sm:hidden">
                                  {formattedBooking.status.substring(0, 4)}
                                </span>
                              </span>
                            </td>
                            ...
                            <td className="px-3 sm:px-6 py-4 whitespace-nowrap text-sm font-medium">
                              <div className="flex items-center space-x-1 sm:space-x-2">
                                ...
                                {[
                                  ...
                                  formattedBooking.status?.toLowerCase()
                                ) && (
                                  <button
                                    onClick={() =>
                                      navigate(`${booking._id}/handover`)
                                    }
                                    className="text-purple-600 hover:text-purple-900 p-1 sm:p-2"
                                ...
                                {[
                                  ...
                                  "in-progress",
                                  "ongoing",
                                ].includes(formattedBooking.status) && (
                                  <button
                                    onClick={() => {
        ...
        {activeTab === "pending_approval" && (
          <div className="bg-white rounded-lg shadow overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-500">
                These bookings have been paid but need your approval to proceed.
              </p>
            </div>
                          ...
                          <div className="flex items-center justify-between mt-2">
                            <div className="flex items-center space-x-3">
                              <span className="text-sm text-gray-600">
                                ...
                                <span className="sm:hidden">
                                  {
                                    formattedBooking.customer?.name?.split(
                                      " "
                                    )[0]
                                  }
                                </span>
                            ...
                            {/* Headcount Bubble */}
                            <div className="bg-blue-100 text-blue-800 text-xs font-semibold inline-flex items-center justify-center w-8 h-8 rounded-full border border-blue-200">
                      ...
                      <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
                        ...
                        <div className="flex items-center space-x-2 w-full sm:w-auto">
                          <button
                            ...
                            className="flex-1 sm:flex-none px-3 sm:px-4 py-2 text-sm font-medium text-red-700 bg-red-100 hover:bg-red-200 rounded-md transition-colors"
                          ...
                          <button
                            ...
                            className="flex-1 sm:flex-none px-3 sm:px-4 py-2 text-sm font-medium text-green-700 bg-green-100 hover:bg-green-200 rounded-md transition-colors"
                            disabled={isApproving}
                          >
            ...
            {getPendingApprovalBookings().length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 max-w-md mx-auto">
                  All bookings have been reviewed. New booking requests
        ...
        {activeTab === "extensions" && (
          <div className="bg-white rounded-lg shadow overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-500">
                Customers requesting to extend their booking duration.
              </p>
            </div>
            ...
            <div className="divide-y divide-gray-200">
              {extensionsLoading ? (
                ...
                pendingExtensions?.data?.map((extension) => (
                  <div
                    key={`${extension.bookingId}-${extension.extensionRequest.requestId}`}
                    className="px-4 sm:px-6 py-4 hover:bg-gray-50"
                  >
                          ...
                          <div className="flex items-center justify-between mt-2">
                            <div className="flex items-center space-x-3">
                              <span className="text-sm text-gray-600">
                                ...
                                <span className="sm:hidden">
                                  {
                                    (extension.customer?.name || "N/A").split(
                                      " "
                                    )[0]
                                  }
                                </span>
                            ...
                            <div className="bg-blue-100 text-blue-800 text-xs font-semibold inline-flex items-center justify-center w-8 h-8 rounded-full border border-blue-200">
                              ...
                              <span>
                                {extension.headCount ||
                                  extension.passengers ||
                                  extension.guestCount ||
                                  1}
                              </span>
                            </div>
                          </div>
                      ...
                      <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
                        <div className="text-left sm:text-right">
                          ...
                          <div className="text-sm text-blue-600 font-medium">
                            Requested End:{" "}
                            {formatDate(
                              extension.extensionRequest.requestedEndDateTime
                            )}
                          </div>
                          <div className="text-sm text-gray-500">
                            Additional:{" "}
                            {extension.extensionRequest.additionalHours} hours
                          </div>
                          <div className="text-lg font-semibold text-gray-900">
                            ₹
                            {(
                              extension.extensionRequest.additionalAmount +
                              extension.extensionRequest.additionalGst
                            )?.toLocaleString()}
                          </div>
                        </div>
            ...
            {!extensionsLoading && pendingExtensions?.data?.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 max-w-md mx-auto">
                  Customer extension requests will appear here for your review
                  and approval.
                </p>
              </div>
            )}
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Booking #
                    {formatBookingForDisplay(selectedBooking)?.bookingNumber}
                  </p>
                  <p className="text-sm text-gray-600">
                    Customer:{" "}
                    {formatBookingForDisplay(selectedBooking)?.customer?.name}
                  </p>
                  <p className="text-sm text-gray-600">
                    Amount: ₹
                    {formatBookingForDisplay(
              ...
              <div className="flex items-center justify-end space-x-3">
                ...
                >
                  ...
                  {approvalData.action === "approve" ? "Approve" : "Deny"}{" "}
                  Booking
                </button>
              </div>
            </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div>
                      ...
                      <span className="ml-2 font-medium">
                        #{selectedExtension.bookingNumber}
                      </span>
                    </div>
                    <div>
                      <span className="text-gray-500">Vehicle:</span>
                      <span className="ml-2 font-medium">
                        {selectedExtension.vehicle?.vehicleNo}
                      </span>
                    </div>
                    <div>
                      <span className="text-gray-500">Customer:</span>
                      <span className="ml-2 font-medium">
                        {selectedExtension.customer?.name}
                      </span>
                    </div>
                    <div>
                      <span className="text-gray-500">Phone:</span>
                      <span className="ml-2 font-medium">
                        {selectedExtension.customer?.phone}
                      </span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {formatDate(selectedExtension.currentEndTime)}
                      </span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {selectedExtension.extensionRequest.additionalHours}{" "}
                        hours
                      </span>
                    </div>
                    <div className="flex justify-between border-t pt-2 mt-2">
                      ...
                      <span className="font-semibold text-lg">
                        ₹
                        {(
                          selectedExtension.extensionRequest.additionalAmount +
                          selectedExtension.extensionRequest.additionalGst
                        )?.toLocaleString()}
                      </span>
                    </div>
                  </div>
                ...
                <button
                  onClick={() =>
                    handleExtensionResponse(
                      "reject",
                      "Extension not feasible at this time"
                    )
                  }
