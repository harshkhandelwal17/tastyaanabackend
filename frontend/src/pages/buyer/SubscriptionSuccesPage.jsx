...
const SubscriptionDetailPage = () => {
  ...
  if (subscriptionsError || detailError || !subscription) {
    return (
      <div className="min-h-screen bg-slate-50 pb-20">
        <div className="max-w-3xl mx-auto px-4 pt-6">
          <button
      ...
      <div className="max-w-4xl mx-auto px-4 pt-5 space-y-5">
        ...
        <section className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 sm:p-5">
          <div className="flex items-center gap-2 mb-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Aaj ka complete menu, isi subscription ke hisaab se.
              </p>
            </div>
          </div>
          ...
          {!todayMealLoading && !todayMealError && (
            <>
              {todayItems.length > 0 ? (
                <div className="p-3 rounded-xl bg-slate-50 text-sm text-slate-800">
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      ...
                      <div className="text-[11px] text-slate-500 mt-2">
                        {todayMealData?.tier && `Tier: ${todayMealData.tier} • `}
                        {todayMealData?.shift && `Shift: ${todayMealData.shift} • `}
