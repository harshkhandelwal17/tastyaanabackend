 ...
 * @access  Public
 */
router.get('/today/all', getAllTodaysMeals);

/**
 * @route   POST /api/dailymeals/today
 * @desc    Add today's meal
 * @access  Private (Admin/Restaurant)
 * @description Note: Placed after /today/all to ensure specific route takes precedence if needed, though they don't conflict directly.
 */
